...
<html lang="en">
    <head>
        ...
        <title>Quỹ từ thiện công khai</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="footer-widget">
                                ...
                                <ul>
                                    <li><a target="_blank" href="https://m.do.co/c/84c9b45d0c47">Mới nhất</a></li>
                                    <li><a target="blank" href="https://www.cloudways.com/en/pricing.php?id=153986&amp;a_bid=005da123">Liên hệ</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="footer-widget">
                                <h5 class="title">Giúp đỡ</h5>
                                <ul>
                                    <li><a href="https://www.wowthemes.net/premium-themes-templates/">Trợ giúp</a></li>
                                    <li><a target="_blank" href="https://www.wowthemes.net/affiliate-area/">Gớp ý</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="footer-widget textwidget">
                                ...
                                <a href="https://gum.co/affiliates-html-template" target="_blank">facebook</a>
                            </div>
                        </div>
                    </div>
                    <div class="copyright">
                        ...
                        <p class="pull-right">
                            <a target="_blank" href="https://www.wowthemes.net/affiliates-free-bootstrap-template/"></a> Thiết kế bởi quytuthiencongkhai.vn
                        </p>
                        <div class="clearfix">
                        </div>
                    </div>
